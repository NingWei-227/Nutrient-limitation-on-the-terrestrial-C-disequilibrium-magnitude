...
cd('F:\My research\case2\JGR\Working\step4_PlantSoil')   
...
%% Figure7,The spatial patterns of ?Xc in plant and its three determants over the period of 1901-2013.
% re_NPP * tuaE0, re_tuaE * NPP0,  re_NPP * re_tuaE and Xc
% for plant and soil
...
fct_Xc_Cp = fct_reNPP_Cp+fct_retuaE_Cp+fct_reNPPtuaE_Cp;
...
fct_Xc_CNp = fct_reNPP_CNp+fct_retuaE_CNp+fct_reNPPtuaE_CNp;
...
fct_Xc_CNPp = fct_reNPP_CNPp+fct_retuaE_CNPp+fct_reNPPtuaE_CNPp;

% preparing for dataset 
Data_reNPPtuaE_p(:,:,1) = fct_Xc_Cp;
Data_reNPPtuaE_p(:,:,2) = fct_reNPP_Cp;
Data_reNPPtuaE_p(:,:,3) = fct_retuaE_Cp;
Data_reNPPtuaE_p(:,:,4) = fct_reNPPtuaE_Cp;

Data_reNPPtuaE_p(:,:,5) = fct_Xc_CNp;
Data_reNPPtuaE_p(:,:,6) = fct_reNPP_CNp;
Data_reNPPtuaE_p(:,:,7) = fct_retuaE_CNp;
Data_reNPPtuaE_p(:,:,8) = fct_reNPPtuaE_CNp;

Data_reNPPtuaE_p(:,:,9) = fct_Xc_CNPp;
Data_reNPPtuaE_p(:,:,10) = fct_reNPP_CNPp;
Data_reNPPtuaE_p(:,:,11) = fct_retuaE_CNPp;
Data_reNPPtuaE_p(:,:,12) = fct_reNPPtuaE_CNPp;
...
h.Position = [0.054,0.089,0.2134,0.0223]
...
h = colorbar
h.Location = 'southoutside';
h.Position = [0.286,0.089,0.2056,0.0223]
h.Label.FontName = 'Arial'
h.Label.FontSize = 10;
text(-0.0379,-2.39, 'KgC m^-^2','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',10)
...
h = colorbar
h.Location = 'southoutside';
h.Position = [0.52,0.089,0.4063,0.0223]
h.Label.FontName = 'Arial'
h.Label.FontSize = 10;
text(-3.3712,-2.39, 'KgC m^-^2','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',10)

text(-19.716,10.4495, '\DeltaXc','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',10)    
text(-13.1481,10.4495, '\tau_E_0 X \DeltaNPP','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',10)        
text(-6.1,10.4495, '\Delta\tau_E X NPP_0','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',10)    
text(0.3,10.4495, '\Delta\tau_E X \DeltaNPP','HorizontalAlignment','center',...
        'FontName','Arial','FontSize',10) 
    
text(-24,9, 'C','HorizontalAlignment','left',...
        'FontName','Arial','FontSize',10)        
text(-24,5, 'CN','HorizontalAlignment','left',...
        'FontName','Arial','FontSize',10)    
text(-24,1, 'CNP','HorizontalAlignment','left',...
        'FontName','Arial','FontSize',10)   
...
fct_Xc_Cs = fct_reNPP_Cs+fct_retuaE_Cs+fct_reNPPtuaE_Cs;
...
fct_Xc_CNs = fct_reNPP_CNs+fct_retuaE_CNs+fct_reNPPtuaE_CNs;
...
fct_Xc_CNPs = fct_reNPP_CNPs+fct_retuaE_CNPs+fct_reNPPtuaE_CNPs;

% preparing for dataset 
Data_reNPPtuaE_s(:,:,1) = fct_Xc_Cs;
Data_reNPPtuaE_s(:,:,2) = fct_reNPP_Cs;
Data_reNPPtuaE_s(:,:,3) = fct_retuaE_Cs;
Data_reNPPtuaE_s(:,:,4) = fct_reNPPtuaE_Cs;

Data_reNPPtuaE_s(:,:,5) = fct_Xc_CNs;
Data_reNPPtuaE_s(:,:,6) = fct_reNPP_CNs;
Data_reNPPtuaE_s(:,:,7) = fct_retuaE_CNs;
Data_reNPPtuaE_s(:,:,8) = fct_reNPPtuaE_CNs;

Data_reNPPtuaE_s(:,:,9) = fct_Xc_CNPs;
Data_reNPPtuaE_s(:,:,10) = fct_reNPP_CNPs;
Data_reNPPtuaE_s(:,:,11) = fct_retuaE_CNPs;
Data_reNPPtuaE_s(:,:,12) = fct_reNPPtuaE_CNPs;
